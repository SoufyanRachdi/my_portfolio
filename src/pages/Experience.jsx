          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-slate-300 text-sm md:text-base leading-relaxed mt-3">
                Led the end-to-end mobile architecture and backend development of <span className="text-slate-100 font-medium">Caredify</span>, a remote cardiac monitoring ecosystem acquiring live ECG telemetry over Bluetooth Low Energy (BLE) and synchronizing with a cloud backend.
              </p>
