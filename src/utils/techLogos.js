export const techLogoMap = {
  ...
  'Express.js': '/softwarelogo/express-icon.svg',
  Express: '/softwarelogo/express-icon.svg',
  NestJS: '/softwarelogo/nestjs-icon.svg',
  'Socket.IO': '/softwarelogo/socketio-icon.svg',
  ...
  MongoDB: '/softwarelogo/mongodb-icon.svg',
  'MongoDB Atlas': '/softwarelogo/mongodb-icon.svg',
  Supabase: '/softwarelogo/supabase-icon.svg',
  CockroachDB: '/softwarelogo/cockroachdb-icon.svg',
  PostgreSQL: '/softwarelogo/sqlite-icon.svg',
  ...
  Android: '/softwarelogo/android-studio-icon.svg',
  'Android SDK': '/softwarelogo/android-studio-icon.svg',
  'Accessibility Service': '/softwarelogo/android-studio-icon.svg',
