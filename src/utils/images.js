export const caredifyProjectImages = Object.values(
  import.meta.glob('/public/projectsimages/caredify/*.{png,jpg,jpeg,svg}', { eager: true })
).map((m) => m.default);

export const footballManagerProjectImages = Object.values(
...
export const lawyerAppProjectImages = Object.values(
  import.meta.glob('/public/projectsimages/lawyer-app/*.{png,jpg,jpeg,svg}', { eager: true })
).map((m) => m.default);